...
const data = [
  ...
  */
    ...
    function makethedamnArticle(title, date, content){
      ...
      Article.appendChild(ArticleBar)
        Article.appendChild(ContentofArticle)
       
        ArticleBar.appendChild(Titles)
        ArticleBar.appendChild(Dates)
      ArticleBar.appendChild(buttons)
        ...
        ContentofArticle.classList.add("article")
        closeButton.classList.add("close")
        
        buttons.addEventListener("click", function(event){
          openButton.classList.toggle("close", "article")
          closeButton.classList.toggle("close","article")
          ContentofArticle.classList.toggle("article-open")
          
        })
         return Article}
      
      const wholeArticle=document.querySelector(".articles")
      data.map(function(itemss){
        wholeArticle.appendChild(makethedamnArticle(itemss.title, itemss.date, itemss.content))})
